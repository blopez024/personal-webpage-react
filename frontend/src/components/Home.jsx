  ...
  return (
    <div className="bio" id="home">
      <div className="bio-text">
        ...
        <div className="bio-links">
          <ul>
              ...
              >
                <button type="button">
                  ...
                  <svg
                    ...
                    className="lucide lucide-file-down ml-2 size-5 resume"
                  >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/blopez24/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
            ...
            <li>
              <a
                href="https://github.com/blopez024/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
      ...
      <div className="profile">
        <img src={profile} alt="photo of bryan" />
      </div>
    </div>
  );
};
